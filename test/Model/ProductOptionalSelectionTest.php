...
/**
 * ProductOptionalSelectionTest Class Doc Comment
 *
 * @category    Class
 * @description Selection facultative des options (la pop-up de selection des options ne sera pas affichée automatiquement)
 * @package     Qwenta\Fulleapps
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProductOptionalSelectionTest extends TestCase
{
    ...
    /**
     * Test "ProductOptionalSelection"
     */
    public function testProductOptionalSelection()
    {
    }
}

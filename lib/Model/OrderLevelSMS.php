...
/**
 * OrderLevelSMS Class Doc Comment
 *
 * @category Class
 * @description Class OrderLevelSMS
 * @package  Qwenta\Fulleapps
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrderLevelSMS implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OrderLevelSMS';
     ...
     * Sets archive
     *
     * @param  $archive 1 si activé, sinon 0
     *
     * @return $this
     */
     ...
     * Sets text
     *
     * @param  $text Modèle de SMS à envoyer au client
     *
     * @return $this
     */
     ...
     * Sets country
     *
     * @param  $country Code pays associé au modèle de SMS
     *
     * @return $this
     */

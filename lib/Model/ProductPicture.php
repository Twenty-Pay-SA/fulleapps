...
/**
 * ProductPicture Class Doc Comment
 *
 * @category Class
 * @description Class ProductPicture
 * @package  Qwenta\Fulleapps
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductPicture implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProductPicture';
     ...
     * Sets image
     *
     * @param  $image Picture URLs (72x72, 128x128, 256x256, 512x512)
     *
     * @return $this
     */

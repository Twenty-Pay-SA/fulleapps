...
/**
 * RubricIdParent Class Doc Comment
 *
 * @category Class
 * @description Identifiant de la rubrique parente (non géré en création / modification)
 * @package  Qwenta\Fulleapps
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RubricIdParent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'rubric_id_parent';

...
/**
 * ProductEnableComment Class Doc Comment
 *
 * @category Class
 * @description [WEBSHOP] 1 pour autoriser les commentaires libre, 0 pour les désactiver
 * @package  Qwenta\Fulleapps
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductEnableComment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'product_enable_comment';

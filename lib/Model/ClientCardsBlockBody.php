...
/**
 * ClientCardsBlockBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ClientCardsBlockBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'client_cards_block_body';
    ...
    {
        $this->container['id_sms'] = isset($data['id_sms']) ? $data['id_sms'] : null;
    ...
    {
        return $this->container['id_sms'];
    }

    /**
     * Sets id_sms
     *
     * @param Int $id_sms ID SMS
     *
     * @return $this
     */
    public function setIdSms($id_sms)
    {
        $this->container['id_sms'] = $id_sms;
     ...
     * Sets code
     *
     * @param Int $code SMS generated code
     *
     * @return $this
     */

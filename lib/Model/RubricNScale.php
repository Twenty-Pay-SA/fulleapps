...
/**
 * RubricNScale Class Doc Comment
 *
 * @category Class
 * @description [Option Balances Data Collect requis] Numéro de section (code unique de la rubrique sur la balance)
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RubricNScale implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'rubric_n_scale';

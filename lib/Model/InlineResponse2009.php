...
class InlineResponse2009 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'code' => 'Int',
        'message' => 'string',
        'object' => '\Qwenta\Fulleapps\Model\Client'
    ];
     ...
     * Sets code
     *
     * @param Int $code Response code<br/>                                 - CODE_OK (1) = Success<br/>                                 - CODE_ERR_UNAUTHORIZED (-10) = Unauthorized<br/>                                 - CODE_ERR_NOT_FOUND (-21) = Client not found<br/>                                 - CODE_ERR_PHONE_NOT_VALID (-15) = Phone not valid<br/>                                 - CODE_ERR_INSERT (-1) = Intern error
     *
     * @return $this
     */
     ...
     * Sets object
     *
     * @param \Qwenta\Fulleapps\Model\Client $object object
     *
     * @return $this
     */

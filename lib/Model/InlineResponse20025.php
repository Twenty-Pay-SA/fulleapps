...
class InlineResponse20025 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'request' => 'object',
        'list' => '\Qwenta\Fulleapps\Model\TaxGrouping[]',
        'tax_grouping_processing_fees' => 'int'
    ];
    ...
    protected static $swaggerFormats = [
        'request' => null,
        'list' => null,
        'tax_grouping_processing_fees' => null
    ];
    ...
    protected static $attributeMap = [
        'request' => 'request',
        'list' => 'list',
        'tax_grouping_processing_fees' => 'tax_grouping_processing_fees'
    ];
    ...
    protected static $setters = [
        'request' => 'setRequest',
        'list' => 'setList',
        'tax_grouping_processing_fees' => 'setTaxGroupingProcessingFees'
    ];
    ...
    protected static $getters = [
        'request' => 'getRequest',
        'list' => 'getList',
        'tax_grouping_processing_fees' => 'getTaxGroupingProcessingFees'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['tax_grouping_processing_fees'] = isset($data['tax_grouping_processing_fees']) ? $data['tax_grouping_processing_fees'] : null;
    }
     ...
     * Gets list
     *
     * @return \Qwenta\Fulleapps\Model\TaxGrouping[]
     */
     ...
     * Sets list
     *
     * @param \Qwenta\Fulleapps\Model\TaxGrouping[] $list list
     *
     * @return $this
     */
    ...
    /**
     * Gets tax_grouping_processing_fees
     *
     * @return int
     */
    public function getTaxGroupingProcessingFees()
    {
        return $this->container['tax_grouping_processing_fees'];
    }

    /**
     * Sets tax_grouping_processing_fees
     *
     * @param int $tax_grouping_processing_fees Idenfifiant du regroupement associé aux frais Webshop
     *
     * @return $this
     */
    public function setTaxGroupingProcessingFees($tax_grouping_processing_fees)
    {
        $this->container['tax_grouping_processing_fees'] = $tax_grouping_processing_fees;

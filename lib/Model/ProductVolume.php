...
/**
 * ProductVolume Class Doc Comment
 *
 * @category Class
 * @description Volume du produit (en litre) (pour la gestion balances)
 * @package  Qwenta\Fulleapps
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductVolume implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'product_volume';

...
/**
 * AccountantSettingBankModel Class Doc Comment
 *
 * @category Class
 * @description Class AccountantSettingBankModel
 * @package  Qwenta\Fulleapps
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AccountantSettingBankModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccountantSettingBankModel';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['id_bank'] = isset($data['id_bank']) ? $data['id_bank'] : null;
    ...
    {
        return $this->container['id_bank'];
    }

    /**
     * Sets id_bank
     *
     * @param  $id_bank Identifiant de la banque
     *
     * @return $this
     */
    public function setIdBank($id_bank)
    {
        $this->container['id_bank'] = $id_bank;

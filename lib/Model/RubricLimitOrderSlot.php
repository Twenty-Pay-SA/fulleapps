...
/**
 * RubricLimitOrderSlot Class Doc Comment
 *
 * @category Class
 * @description [WEBSHOP] Nombre de commandes autorisées par créneaux horaires
 * @package  Qwenta\Fulleapps
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RubricLimitOrderSlot implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'rubric_limit_order_slot';

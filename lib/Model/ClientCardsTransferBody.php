...
/**
 * ClientCardsTransferBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ClientCardsTransferBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'client_cards_transfer_body';
    ...
    protected static $swaggerTypes = [
        'old_client' => '\Qwenta\Fulleapps\Model\Client',
        'new_client' => '\Qwenta\Fulleapps\Model\Client'
    ];
    ...
    {
        $this->container['old_client'] = isset($data['old_client']) ? $data['old_client'] : null;
    ...
    {
        return $this->container['old_client'];
    }

    /**
     * Sets old_client
     *
     * @param \Qwenta\Fulleapps\Model\Client $old_client old_client
     *
     * @return $this
     */
    public function setOldClient($old_client)
    {
        $this->container['old_client'] = $old_client;
     ...
     * Sets new_client
     *
     * @param \Qwenta\Fulleapps\Model\Client $new_client new_client
     *
     * @return $this
     */

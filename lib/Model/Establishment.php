...
/**
 * Establishment Class Doc Comment
 *
 * @category Class
 * @description Class Establishment
 * @package  Qwenta\Fulleapps
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Establishment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Establishment';
     ...
     * Sets reference
     *
     * @param  $reference Référence externe de l'établissement
     *
     * @return $this
     */

...
/**
 * AttributsClientsApi Class Doc Comment
 *
 * @category Class
 * @package  Qwenta\Fulleapps
 * @author   Swagger Codegen team
...
class AttributsClientsApi
{
     ...
     *
     * @param  \Qwenta\Fulleapps\Model\ClientAttribute $body body (required)
     *
    ...
    /**
     * Operation deleteClientAttribute
     *
     * Suppression d'un attribut client
     *
     * @param  int $id Identifiant de l&#x27;attribut client (required)
     *
     * @throws \Qwenta\Fulleapps\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteClientAttribute($id)
    {
        $this->deleteClientAttributeWithHttpInfo($id);
    }

    /**
     * Operation deleteClientAttributeWithHttpInfo
     *
     * Suppression d'un attribut client
     *
     * @param  int $id Identifiant de l&#x27;attribut client (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteClientAttributeWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->deleteClientAttributeRequest($id);
    ...
    /**
     * Operation deleteClientAttributeAsync
     *
     * Suppression d'un attribut client
     *
     * @param  int $id Identifiant de l&#x27;attribut client (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteClientAttributeAsync($id)
    {
        return $this->deleteClientAttributeAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteClientAttributeAsyncWithHttpInfo
     *
     * Suppression d'un attribut client
     *
     * @param  int $id Identifiant de l&#x27;attribut client (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteClientAttributeAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->deleteClientAttributeRequest($id);
    ...
    /**
     * Create request for operation 'deleteClientAttribute'
     *
     * @param  int $id Identifiant de l&#x27;attribut client (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteClientAttributeRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling deleteClientAttribute'
            );
        }

        $resourcePath = '/client_attributes/delete/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

...
class AdressesApi
{
     ...
     * Modification
     *
     * @param  \Qwenta\Fulleapps\Model\ClientAddress $body body (required)
     *
    ...
    protected function 294d0f9a1d8d475e701a2b353d6ba139Request($body)
    {
        ...
        $resourcePath = '/client_addresses/id';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getClientAddressesWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation getClientAddressesWithHttpInfo
     *
     * Récupération
     *
     * @param  Int $id Identifiant du client (required)
     ...
     * @throws \Qwenta\Fulleapps\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Qwenta\Fulleapps\Model\ClientAddress[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getClientAddressesWithHttpInfo($id)
    {
        $returnType = '\Qwenta\Fulleapps\Model\ClientAddress[]';
        $request = $this->getClientAddressesRequest($id);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Qwenta\Fulleapps\Model\ClientAddress[]',
    ...
    /**
     * Operation getClientAddressesAsync
     *
     * Récupération
     *
     * @param  Int $id Identifiant du client (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getClientAddressesAsync($id)
    {
        return $this->getClientAddressesAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getClientAddressesAsyncWithHttpInfo
     *
     * Récupération
     *
     * @param  Int $id Identifiant du client (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getClientAddressesAsyncWithHttpInfo($id)
    {
        $returnType = '\Qwenta\Fulleapps\Model\ClientAddress[]';
        $request = $this->getClientAddressesRequest($id);
    ...
    /**
     * Create request for operation 'getClientAddresses'
     *
     * @param  Int $id Identifiant du client (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getClientAddressesRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getClientAddresses'
            );
        }

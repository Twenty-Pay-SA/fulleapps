...
class ModesDeReglementApi
{
     ...
     * Création
     *
     * @param  \Qwenta\Fulleapps\Model\PaymentMean $body body (required)
     *
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Qwenta\Fulleapps\Model\InlineResponse20017',
    ...
    /**
     * Operation a3d0703141a0123879ab481cd193887d
     *
     * Suppression
     *
     ...
     * @return void
     */
    public function a3d0703141a0123879ab481cd193887d($id = null)
    {
        $this->a3d0703141a0123879ab481cd193887dWithHttpInfo($id);
    }

    /**
     * Operation a3d0703141a0123879ab481cd193887dWithHttpInfo
     *
     * Suppression
     *
     * @param  int $id Identifiant du mode de réglement (optional)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function a3d0703141a0123879ab481cd193887dWithHttpInfo($id = null)
    {
        $returnType = '';
        $request = $this->a3d0703141a0123879ab481cd193887dRequest($id);
    ...
    /**
     * Operation a3d0703141a0123879ab481cd193887dAsync
     *
     * Suppression
     *
     * @param  int $id Identifiant du mode de réglement (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function a3d0703141a0123879ab481cd193887dAsync($id = null)
    {
        return $this->a3d0703141a0123879ab481cd193887dAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation a3d0703141a0123879ab481cd193887dAsyncWithHttpInfo
     *
     * Suppression
     *
     * @param  int $id Identifiant du mode de réglement (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function a3d0703141a0123879ab481cd193887dAsyncWithHttpInfo($id = null)
    {
        $returnType = '';
        $request = $this->a3d0703141a0123879ab481cd193887dRequest($id);
    ...
    /**
     * Create request for operation 'a3d0703141a0123879ab481cd193887d'
     *
     * @param  int $id Identifiant du mode de réglement (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function a3d0703141a0123879ab481cd193887dRequest($id = null)
    {

        $resourcePath = '/payment_means/delete/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

...
class CompteApi
{
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Qwenta\Fulleapps\Model\InlineResponse200',
     ...
     * Modification
     *
     * @param  \Qwenta\Fulleapps\Model\AccountC $body body (required)
     *
     * @throws \Qwenta\Fulleapps\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
    ...
    {
        $this->updateAccountWithHttpInfo($body);
    }
     ...
     * Modification
     *
     * @param  \Qwenta\Fulleapps\Model\AccountC $body (required)
     *
     * @throws \Qwenta\Fulleapps\ApiException on non-2xx response
     * @throws \InvalidArgumentException

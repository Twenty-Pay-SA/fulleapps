...
/**
 * AppareilsApi Class Doc Comment
 *
 * @category Class
 * @package  Qwenta\Fulleapps
 * @author   Swagger Codegen team
...
class AppareilsApi
{
     ...
     *
     * @param  int $id Identifiant de l&#x27;appareil (Récupération unique) (required)
     *
     * @throws \Qwenta\Fulleapps\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Qwenta\Fulleapps\Model\Device[]
     */
    public function getDevices($id)
    {
        list($response) = $this->getDevicesWithHttpInfo($id);
        return $response;
    }
     ...
     * @throws \Qwenta\Fulleapps\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Qwenta\Fulleapps\Model\Device[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getDevicesWithHttpInfo($id)
    {
        $returnType = '\Qwenta\Fulleapps\Model\Device[]';
        $request = $this->getDevicesRequest($id);
     ...
     */
    public function getDevicesAsync($id)
    {
        return $this->getDevicesAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDevicesAsyncWithHttpInfo($id)
    {
        $returnType = '\Qwenta\Fulleapps\Model\Device[]';
        $request = $this->getDevicesRequest($id);
     ...
     */
    protected function getDevicesRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getDevices'
            );
        }

...
/**
 * NiveauxDeFabricationApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class NiveauxDeFabricationApi
{
    ...
    protected function 2b00caad42538e9be7dab4f1ff320ef9Request($body)
    {
        ...
        $resourcePath = '/v1/kitchen_levels/id';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Qwenta\Fulleapps\Model\KitchenLevel[]',

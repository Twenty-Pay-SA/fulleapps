...
/**
 * LocalisationsApi Class Doc Comment
 *
 * @category Class
 * @package  Qwenta\Fulleapps
 * @author   Swagger Codegen team
...
class LocalisationsApi
{
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Qwenta\Fulleapps\Model\Country[]',
     ...
     *
     * @param  int $id_country Récupération des villes par pays (required)
     * @param  int $postal_code Récupération des villes par code postal (required)
     *
     * @throws \Qwenta\Fulleapps\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Qwenta\Fulleapps\Model\City[]
     */
    public function getCities($id_country, $postal_code)
    {
        list($response) = $this->getCitiesWithHttpInfo($id_country, $postal_code);
        return $response;
    }
     ...
     * @throws \Qwenta\Fulleapps\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Qwenta\Fulleapps\Model\City[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getCitiesWithHttpInfo($id_country, $postal_code)
    {
        $returnType = '\Qwenta\Fulleapps\Model\City[]';
        $request = $this->getCitiesRequest($id_country, $postal_code);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCitiesAsync($id_country, $postal_code)
    {
        return $this->getCitiesAsyncWithHttpInfo($id_country, $postal_code)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCitiesAsyncWithHttpInfo($id_country, $postal_code)
    {
        $returnType = '\Qwenta\Fulleapps\Model\City[]';
        $request = $this->getCitiesRequest($id_country, $postal_code);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCitiesRequest($id_country, $postal_code)
    {
        // verify the required parameter 'id_country' is set
        if ($id_country === null || (is_array($id_country) && count($id_country) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id_country when calling getCities'
            );
        }
        // verify the required parameter 'postal_code' is set
        if ($postal_code === null || (is_array($postal_code) && count($postal_code) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $postal_code when calling getCities'
            );
        }
        ...
        if ($id_country !== null) {
            $resourcePath = str_replace(
                '{' . 'id_country' . '}',
                ObjectSerializer::toPathValue($id_country),
                $resourcePath
            );
        }
        // path params
     ...
     *
     * @param  int $id_country Identifiant du pays (required)
     *
     * @throws \Qwenta\Fulleapps\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function getPostalCodes($id_country)
    {
        $this->getPostalCodesWithHttpInfo($id_country);
    }
     ...
     */
    public function getPostalCodesWithHttpInfo($id_country)
    {
        $returnType = '';
        $request = $this->getPostalCodesRequest($id_country);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPostalCodesAsync($id_country)
    {
        return $this->getPostalCodesAsyncWithHttpInfo($id_country)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPostalCodesAsyncWithHttpInfo($id_country)
    {
        $returnType = '';
        $request = $this->getPostalCodesRequest($id_country);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPostalCodesRequest($id_country)
    {
        // verify the required parameter 'id_country' is set
        if ($id_country === null || (is_array($id_country) && count($id_country) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id_country when calling getPostalCodes'
            );
        }

        $resourcePath = '/v1/postal_codes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

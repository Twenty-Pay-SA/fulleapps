...
/**
 * CategoriesFormulesApi Class Doc Comment
 *
 * @category Class
 * @package  Qwenta\Fulleapps
 * @author   Swagger Codegen team
...
class CategoriesFormulesApi
{
    ...
    {
        list($response) = $this->getWithHttpInfo($id, $type);
        return $response;
    }
     ...
     */
    public function getWithHttpInfo($id, $type)
    {
        $returnType = '\Qwenta\Fulleapps\Model\ProductCategory[]';
        $request = $this->getRequest($id, $type);
     ...
     */
    public function getAsync($id = null, $type = null)
    {
        return $this->getAsyncWithHttpInfo($id, $type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAsyncWithHttpInfo($id, $type)
    {
        $returnType = '\Qwenta\Fulleapps\Model\ProductCategory[]';
        $request = $this->getRequest($id, $type);
     ...
     */
    protected function getRequest($id, $type)
    {
